...
export class VieweditcurrentuserComponent {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: any,private _UsersService:UsersService, private _AuthServicesService:AuthServicesService, private _ToastrService:ToastrService
  ) {}
